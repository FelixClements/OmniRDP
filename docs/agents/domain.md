...
If the concept you need isn't in the glossary yet, either reconsider whether the project already uses a different term or note the gap for `/grill-with-docs`.
