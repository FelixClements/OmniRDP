...
typedef struct BackendClient {
  ...
  BOOL (*orig_surface_bits)(rdpContext *context,
                            const SURFACE_BITS_COMMAND *cmd);
  BOOL (*orig_surface_frame_marker)(rdpContext *context,
                                    const SURFACE_FRAME_MARKER *marker);
  BOOL (*orig_primary_order_info)(rdpContext *context,
                                  const ORDER_INFO *order_info,
                                  const char *order_name);
  BOOL (*orig_secondary_cache_order_info)(rdpContext *context,
