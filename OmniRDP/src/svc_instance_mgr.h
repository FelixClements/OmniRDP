...
extern "C"
{
	 ...
	 */
	int inst_mgr_init(InstanceManager* mgr, SvcConfig* config, const char* configPath,
	                  const char* exePath);
	 ...
	 */
	int inst_mgr_get_info(InstanceManager* mgr, unsigned int index, PipeInstanceInfo* info);
